...
// Definición de categorías sin la opción de asesores (ya que las tarjetas digitales no van en el portal de inmuebles)
...
export default function Home({ session }) {
  ...
  // Leer estado de activación/desactivación del CRM desde localStorage
  const staticStatusMap = useMemo(() => {
    try {
  ...
  // Filtrar Desarrollos/Landings locales (excluye desactivados desde el CRM)
