...
const desarrollosList = [
  {
    ...
    amenidades: ['Club Campestre con Piscina', 'Senderos Ecológicos', 'Acceso Controlado 24/7'],
  ...
  },
  {
    ...
    amenidades: ['Escritura Pública', 'Zona Habitada', 'Construcción Inmediata'],
  ...
  },
  {
    ...
    superficie: '200 m²',
    amenidades: ['Sin Enganche', 'Crédito Inmediato', '6 Amenidades Included'],
  ...
  },
  {
    ...
    superficie: '200 m²',
    amenidades: ['A 12 min de Tuxtla', 'Desarrollo Eco-Campestre', 'Seguridad 24/7'],
  ...
  },
  {
    ...
    superficie: '200 m²',
    amenidades: ['Escritura Pública', 'Clave Catastral Individual', 'Alta Plusvalía'],
  ...
  },
  {
    ...
    amenidades: ['Acceso a Río', 'Senderos y Cabañas', 'Escritura Pública'],
  ...
  },
  {
    ...
    amenidades: ['Escritura Pública', 'Precio de Contado Oportunidad', 'A minutos de Tuxtla'],
  ...
  },
  {
    ...
    amenidades: ['Casa Habitable', '+2,200 m² Terreno', 'Alta Plusvalía'],
    ubicacionNota: 'Berriozábal, Chiapas',
    whatsapp: 'https://wa.me/529612466204',
    esDesarrollo: true,
    status: 'Disponible',
  ...
  },
  {
    ...
    amenidades: ['Alberca Privada', 'Parque Central', '3 Recámaras / 3 Baños'],
    ubicacionNota: 'Tuxtla Gutiérrez, Chiapas',
    whatsapp: 'https://wa.me/529612466204',
    esDesarrollo: true,
    status: 'Disponible',
  ...
  },
  {
    ...
    superficie: '200 m²',
    amenidades: ['Listos para Escritura', '8.5 km Libramiento Sur', 'Sin Bancos'],
  ...
  },
  {
    ...
    superficie: '200 m² (10×20 m)',
    amenidades: ['Calles de 10m', 'Factibilidad Eléctrica', 'Zona Copoya'],
  ...
  },
  {
    ...
    superficie: 'Lotes Residenciales',
    amenidades: ['Zona Dorada Tuxtla', '5 min Club Campestre', 'Certeza Legal'],
...
const content = `// ─── Fichas Inmobiliarias Curadas y Completas de Landings ─────────────────────
...
console.log('Successfully wrote', desarrollosList.length, 'curated property cards to desarrollos.js');
