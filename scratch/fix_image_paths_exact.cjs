...
const desarrollosList = [
  {
    ...
    amenidades: ['Club Campestre con Piscina', 'Senderos Ecológicos', 'Acceso Controlado 24/7', 'Escritura Pública'],
  ...
  },
  {
    ...
    superficie: '200 m²',
    amenidades: ['A 12 min de Tuxtla', 'Seguridad 24/7', 'Entorno Eco-Campestre', 'Portón de Acceso'],
  ...
  },
  {
    ...
    superficie: '200 m²',
    amenidades: ['Escritura Pública', 'Clave Catastral Individual', 'Excelente Clima', 'Sin Enganche'],
  ...
  },
  {
    ...
    superficie: '200 m² (10×20 m)',
    amenidades: ['Escritura Pública', 'Zona Habitada', 'Construcción Inmediata', 'Recorrido Virtual 360°'],
  ...
  },
  {
    ...
    amenidades: ['Acceso a Río Natural', 'Zona de Cabañas', 'Senderos Ecológicos', 'Escritura Pública'],
  ...
  },
  {
    ...
    amenidades: ['Escritura Pública', 'A minutos de Tuxtla', 'Precio de Contado Oportunidad', 'Certeza Legal'],
  ...
  },
  {
    ...
    amenidades: ['Casa Habitable', '+2,200 m² Terreno Privado', 'Árboles Frutales', 'Potencial de Eventos'],
    ubicacionNota: 'Berriozábal, Chiapas',
    whatsapp: 'https://wa.me/529612466204',
    esDesarrollo: true,
    status: 'Disponible',
  ...
  },
  {
    ...
    amenidades: ['Alberca Privada', 'Parque Central', '3 Recámaras / 3 Baños', '2 Niveles de Lujo'],
  ...
  },
  {
    ...
    superficie: '200 m²',
    amenidades: ['Listos para Escritura', '8.5 km del Libramiento', 'Pago Directo Sin Bancos'],
  ...
  },
  {
    ...
    superficie: '200 m² (10×20 m)',
    amenidades: ['Calles de 10m', 'Factibilidad Eléctrica', 'Zona Copoya Tuxtla'],
  ...
  },
  {
    ...
    amenidades: ['Zona Dorada Tuxtla', '5 min Club Campestre', 'Certeza Legal', 'Plusvalía Garantizada'],
...
// Validar que 100% de los archivos existen localmente antes de guardar
let allOk = true;
desarrollosList.forEach(dev => {
  if (dev.imagen && dev.imagen.startsWith('/') && !fs.existsSync('./public' + dev.imagen)) {
    console.error('ERROR: Cover image missing for', dev.titulo, ':', dev.imagen);
    allOk = false;
  }
  dev.galeria.forEach(g => {
    if (g.startsWith('/') && !fs.existsSync('./public' + g)) {
      console.error('ERROR: Gallery image missing for', dev.titulo, ':', g);
      allOk = false;
    }
  });
});
...
if (allOk) {
  console.log('✅ ALL IMAGE PATHS VERIFIED TO EXIST 100% LOCALLY!');
  const content = `// ─── Fichas Inmobiliarias con Verificación Local de Imágenes 100% Nítidas ───
export const DESARROLLOS = ${JSON.stringify(desarrollosList, null, 2)};
`;
  fs.writeFileSync(path.join(__dirname, '../src/data/desarrollos.js'), content, 'utf8');
} else {
  console.error('FAILED TO VERIFY ALL IMAGES!');
}
