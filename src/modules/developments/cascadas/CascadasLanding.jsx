  ...
  return (
    <div className="cds-page">
      ...
      <main>
        ...
        <section id="informacion" className="cds-section cds-info"><div className="cds-wrap"><SectionHeading eyebrow="UNA FORMA CLARA DE EMPEZAR" title="Terrenos desde $370,000">Un espacio de 200 m² para comenzar tu patrimonio, con un enganche accesible y un plan de pagos definido.</SectionHeading><div className="cds-pricing"><div className="cds-price-main"><span>COMIENZA CON</span><strong>$25,000 <small>MXN</small></strong><p>de enganche para dar el primer paso hacia tu terreno propio.</p><WhatsApp intent="price" className="cds-button cds-button-primary">Quiero conocer el plan <ArrowRight size={18} /></WhatsApp></div><div className="cds-price-details"><div className="cds-price-from"><span>TERRENOS DESDE</span><strong>$370,000 <small>MXN</small></strong></div><div><span>El espacio para tu proyecto</span><strong>200 m² · 10 × 20 m</strong></div><div><span>Un plan para avanzar a tu ritmo</span><strong>80 pagos de $4,312.50</strong></div><p>Este es el precio inicial de los terrenos de 200 m². Hay lotes de mayor superficie y distintas ubicaciones con otros precios.</p></div></div></div></section>
