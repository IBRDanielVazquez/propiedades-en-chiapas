  ...
  return (
    <div className="cds-page">
      ...
      <main>
        ...
        <section id="informacion" className="cds-section cds-info"><div className="cds-wrap"><SectionHeading eyebrow="TU TERRENO PUEDE EMPEZAR HOY" title="Hazlo tuyo desde $25,000 de enganche">Un plan claro para dejar de imaginarlo y comenzar a construirlo: 200 m² para tu patrimonio, con mensualidades que te permiten avanzar paso a paso.</SectionHeading><div className="cds-pricing"><div className="cds-price-main"><span>EMPIEZA A HACERLO TUYO</span><strong>$25,000 <small>MXN</small></strong><p>Da el enganche y comienza el camino hacia un terreno propio de 200 m².</p><WhatsApp intent="price" className="cds-button cds-button-primary">Quiero dar el primer paso <ArrowRight size={18} /></WhatsApp></div><div className="cds-price-details"><div className="cds-price-from"><span>TERRENOS DESDE</span><strong>$370,000 <small>MXN</small></strong></div><div><span>El espacio para tu proyecto</span><strong>200 m² · 10 × 20 m</strong></div><div><span>Un plan para avanzar a tu ritmo</span><strong>80 pagos de $4,312.50</strong></div><p>Este es el precio inicial de los terrenos de 200 m². Hay lotes de mayor superficie y distintas ubicaciones con otros precios.</p></div></div></div></section>
